...
@section('content')
    <header>
        <div class="header">
            <div class="title">
                <a href='{{ route('guest.pageTop')}}'><img src='{{secure_asset('images/base/sub2.png')}}'></a>
            </div>
            <div class="b_print">
    ...
    <footer>
        ...
        <div style="width:100%;display:flex;flex-wrap:wrap;justify-content:space-around;">
            ...
            <img src={{secure_asset('images/subsc/amazon.jpg')}} class="bd-placeholder-img card-img-top"  width="100%" height="180" />
            <div class="card-body">
